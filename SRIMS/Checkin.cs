    ...
    public partial class Checkin : UserControl
    {
        ...
        public void settingsReader()
        {
            ...
            if (checkout_list_string != "")
            {
                ...
                string[] individual = checkout_list_string.Split(';');
                foreach (string lol in individual)
                {
                    ...
                    catch (Exception ex) { Console.WriteLine("There Was An Error When Parsing Settings For CheckOutItems"); Console.WriteLine(ex); }
                }
            }
            // Populate ListBox
            population();
